...
abstract class RecordInterface {
	 ...
	 *
	 * @param SourceAndId|array|File_MARC_Record|string|NodeID|int   $recordData     Data to construct the driver from
	 * @access                       public
	 */
	...
	public function getLinkUrl(){
		...
		if (!empty($interface->getTemplateVars('searchId'))){
			...
			$extraParams[] = 'recordIndex=' . $interface->getTemplateVars($this->getSearchPositionVariable());
...
//	}
	...
	public abstract function getRecordActions($isAvailable, $isHoldable, $isBookable, $isHomePickupRecord, $isExternalReservationItem = false, $relatedUrls = null);
