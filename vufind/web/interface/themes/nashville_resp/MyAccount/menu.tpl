				...
				<div class="panel{if $curSection} active{/if}">
					...
					<div id="indexingMenuGroup" class="panel-collapse collapse {if $curSection}in{/if}">
						<div class="panel-body">
							...
							{/if}
							{*<div class="adminMenuLink{if $module == 'Admin' && $action == "OverdriveAPIData"} active{/if}"><a href="/Admin/OverdriveAPIData">OverDrive API Information</a></div>*}
					...
					<div id="reportsMenu" class="panel-collapse collapse {if $curSection}in{/if}">
						<div class="panel-body">
							...
							{if ($ils == 'CarlX' || $ils == 'Sierra') && $loggedIn && (array_key_exists('opacAdmin', $userRoles) || array_key_exists('libraryAdmin', $userRoles) || array_key_exists('locationReports', $userRoles))}
								<div class="adminMenuLink{if $action == "StudentReport"} active{/if}"><a href="/Report/StudentReport">School Overdue Report</a></div>
							{/if}
							{if ($ils == 'CarlX') && $loggedIn && (array_key_exists('opacAdmin', $userRoles) || array_key_exists('libraryAdmin', $userRoles) || array_key_exists('locationReports', $userRoles))}
								<div class="adminMenuLink{if $action == "StudentBarcodes"} active{/if}"><a href="/Report/StudentBarcodes">School Barcodes Report</a></div>
							{/if}
						</div>
					</div>
				</div>
