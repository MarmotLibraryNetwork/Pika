...
<div class="selectTitle">&nbsp;</div>
	<div class="col-sm-3 col-md-3 col-lg-2 text-center">
		<img src="/bookcover.php?isn={$record.isbn|@formatISBN}&amp;issn={$record.issn}&amp;size=medium&amp;upc={$record.upc}" class="listResultImage img-thumbnail img-responsive" alt="{translate text='Cover Image'}"/>
	</div>
