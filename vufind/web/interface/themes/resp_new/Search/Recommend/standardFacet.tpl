{if $cluster.showMoreFacetPopup}
	...
	{/foreach}
	{* Show more list *}
	<div class="facetValue" id="more{$title}"><a href="#" onclick="Pika.ResultsList.moreFacetPopup('More options for {$cluster.label|escape}', '{$title|escape}'); return false;">{translate text='more'} ...</a></div>
...
{else}
	{foreach from=$cluster.list item=thisFacet name="narrowLoop"}
		...
		{* Show More link*}
			<div class="facetValue" id="more{$title|escape}"><a href="#" onclick="Pika.ResultsList.moreFacets('{$title|escape}'); return false;">{translate text='more'} ...</a></div>
	...
	{if $smarty.foreach.narrowLoop.total > $cluster.valuesToShow}
		<div class="facetValue">
			<a href="#" onclick="Pika.ResultsList.lessFacets('{$title|escape}'); return false;">{translate text='less'} ...</a>
		</div>
