...
*}
			<div id="titleScrollerIssues" class="titleScrollerBody">
				<button class="leftScrollerButton enabled btn btn-outline-secondary issuesLeft" aria-label="Previous Issue"><i class="bi bi-chevron-left"></i></button>
				...
				{/if}
				<button class="rightScrollerButton btn btn-outline-secondary issuesRight" aria-label="Next Issue"><i class="bi bi-chevron-right"></i></button>
			</div>
		</div>
	</div>
	<script>
