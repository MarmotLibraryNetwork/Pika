{strip}
	...
	{if $recordDriver->getStreetDate()}
		<div class="row">
			<div class="result-label col-lg-3">{translate text='Street Date'}:</div>
			<div class="col-lg-9 result-value">
	...
	<div class="row">
		<div class="result-label col-lg-3">{translate text='Language'}:</div>
		<div class="col-lg-9 result-value">
	...
	{if !$showISBNs && count($recordDriver->getISBNs()) > 0}
		<div class="row">
			<div class="result-label col-lg-3">{translate text='ISBN'}:</div>
			<div class="col-lg-9 result-value">
	...
	{if count($recordDriver->getUPCs()) > 0}
		<div class="row">
			<div class="result-label col-lg-3">{translate text='UPC'}:</div>
			<div class="col-lg-9 result-value">
	...
	{if count($recordDriver->getASINs()) > 0}
		<div class="row">
			<div class="result-label col-lg-3">{translate text='ASIN'}:</div>
			<div class="col-lg-9 result-value">
	...
	{if $recordDriver->getAcceleratedReaderData() != null}
		...
		<div class="row">
			<div class="result-label col-lg-3">{translate text='Accelerated Reader'}:</div>
			<div class="col-lg-9 result-value">
	...
	{if $recordDriver->getLexileCode()}
		<div class="row">
			<div class="result-label col-lg-3">{translate text='Lexile code'}:</div>
			<div class="col-lg-9 result-value">
	...
	{if $recordDriver->getLexileScore()}
		<div class="row">
			<div class="result-label col-lg-3">{translate text='Lexile measure'}:</div>
			<div class="col-lg-9 result-value">
	...
	{if $recordDriver->getFountasPinnellLevel()}
		<div class="row">
			<div class="result-label col-lg-3">{translate text='Fountas &amp; Pinnell'}:</div>
			<div class="col-lg-9 result-value">
