...
<div id="page-content" class="col-xs-12">
	...
	<div class="alert alert-info">Please enter your complete card number.  Your current {translate text='PIN'} will be sent to the email address on file for your account.</div>
	...
	<form id="emailPin" method="POST" action="/MyAccount/EmailPin" class="form-horizontal">
		...
		<div class="form-group">
			<div class="col-xs-12 col-sm-offset-4 col-sm-8">
				<input id="emailPinSubmit" name="submit" class="btn btn-primary" type="submit" value="{translate text='Email My Pin'}">
			</div>
		</div>
	</form>
</div>
