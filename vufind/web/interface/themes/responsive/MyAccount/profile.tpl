							...
							<div class="panel-body">
								...
								<form action="" method="post" class="form-horizontal" id="pinForm">
									...
									<div class="form-group">
										...
										<div class="col-xs-8">
											<input type="password" name="pin" id="pin" value="" size="4" maxlength="{if $pinMaximumLength}{$pinMaximumLength}{else}64{/if}" class="form-control required{if $numericOnlyPins} digits{else}{if $alphaNumericOnlyPins} alphaNumeric{/if}{/if}">
										</div>
									</div>
									<div class="form-group">
										<div class="col-xs-4"><label for="pin1" class="control-label">{translate text='New PIN'}:</label></div>
										<div class="col-xs-8">
											<input type="password" name="pin1" id="pin1" value="" size="4" maxlength="{if $pinMaximumLength}{$pinMaximumLength}{else}64{/if}" class="form-control required{if $numericOnlyPins} digits{else}{if $alphaNumericOnlyPins} alphaNumeric{/if}{/if}">
										</div>
									</div>
									<div class="form-group">
										<div class="col-xs-4"><label for="pin2" class="control-label">{translate text='Re-enter New PIN'}:</label></div>
										<div class="col-xs-8">
												<input type="password" name="pin2" id="pin2" value="" size="4" maxlength="{if $pinMaximumLength}{$pinMaximumLength}{else}64{/if}" class="form-control required{if $numericOnlyPins} digits{else}{if $alphaNumericOnlyPins} alphaNumeric{/if}{/if}">
										</div>
									</div>
									<div class="form-group">
										<div class="col-xs-8 col-xs-offset-4">
										...
										$("#pinForm").validate({
											rules: {
												pin1: {minlength:{/literal}{if $pinMinimumLength}{$pinMinimumLength}{else}4{/if}{literal},
													maxlength:{/literal}{if $pinMaximumLength}{$pinMaximumLength}{else}64{/if}{literal}},
												pin2: {
													equalTo: "#pin1",
