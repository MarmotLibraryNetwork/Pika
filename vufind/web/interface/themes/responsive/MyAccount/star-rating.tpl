<form action="#" class="star_rating">
    ...
    <fieldset>
        ...
        <input value="1" id="{$id}-star1" type="radio" name="rating" class="visuallyhidden"
               {if $ratingData.user == 1}checked=""{/if} aria-label="Rate {$ratingTitle} 1 star.">
        <label for="{$id}-star1">
        ...
        <input value="2" id="{$id}-star2" type="radio" name="rating" class="visuallyhidden"
               {if $ratingData.user == 2}checked{/if} aria-label="Rate {$ratingTitle} 2 stars.">
        <label for="{$id}-star2">
        ...
        <input value="3" id="{$id}-star3" type="radio" name="rating" class="visuallyhidden"
               {if $ratingData.user == 3}checked{/if} aria-label="Rate {$ratingTitle} 3 stars.">
        <label for="{$id}-star3">
        ...
        <input value="4" id="{$id}-star4" type="radio" name="rating" class="visuallyhidden"
               {if $ratingData.user == 4}checked{/if} aria-label="Rate {$ratingTitle} 4 stars.">
        <label for="{$id}-star4">
        ...
        <input value="5" id="{$id}-star5" type="radio" name="rating" class="visuallyhidden"
               {if $ratingData.user == 5}checked{/if} aria-label="Rate {$ratingTitle} 5 stars.">
        <label for="{$id}-star5">
