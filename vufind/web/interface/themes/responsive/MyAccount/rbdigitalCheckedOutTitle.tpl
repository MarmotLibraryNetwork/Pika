...
<div id="overdrive_{$record.recordId|escape}" class="result row">
		...
		<div class="col-xs-3 col-sm-4 col-md-3 checkedOut-covers-column">
			<div class="row">
				<div class="selectTitle hidden-xs col-sm-1">
					&nbsp;{* rb digital mags are always checked out *}
				</div>
	...
	<div class="{if $showCovers}col-xs-9 col-sm-8 col-md-9{else}col-xs-11{/if}">
		...
		<div class="row">
          ...
          {if $record.issueDate}
						<div class="row">
							<div class="result-label col-tn-4 col-lg-3">{translate text='Issue Date'}</div>
							<div class="result-value col-tn-8 col-lg-9">{$record.issueDate|date_format:"%B %Y"}</div>
						</div>
          {/if}
				...
				<div class="row">
					...
					<div class="result-value col-tn-8 col-lg-9">{$record.format} - {$record.checkoutSource}</div>
				</div>
			...
			<div class="col-xs-9 col-sm-8 col-md-4 col-lg-3">
				<div class="btn-group btn-group-vertical btn-block">
					...
					<a href="#" onclick="return VuFind.RBdigital.returnRBdigitalMagazine('{$record.userId}', '{$record.id}');" class="btn btn-sm btn-warning">Return&nbsp;Now</a>
