{strip}
	...
	{if $recordDriver->getUniformTitle()}
		<div class="row">
			<div class="result-label col-md-4">Uniform Title: </div>
	...
	{if $showPhysicalDescriptions && $recordDriver->getPhysicalDescriptions()}
		<div class="row">
			<div class="result-label col-md-4">{translate text='Physical Desc'}:</div>
			<div class="col-md-8 result-value">
...
{*				{implode subject=$physicalDescriptions glue=", <br>"}*}
	...
	<div class="row">
		...
		{* <div class="col-sm-8 result-value bold statusValue {$statusSummary.class}" id="statusValue">{$statusSummary.groupedStatus|escape}{if $statusSummary.numHolds > 0} ({$statusSummary.numHolds} people are on the wait list){/if}</div> *}
	</div>
