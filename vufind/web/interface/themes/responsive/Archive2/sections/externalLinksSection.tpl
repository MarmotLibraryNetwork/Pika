{strip}
	...
	{if $externalLinks}
		<div class="row archive-field-row">
			<div class="result-label col-md-4">External Link: </div>
	...
	{if $catalogLinks}
		<div class="row archive-field-row">
			<div class="result-label col-md-4">Catalog Link: </div>
			<div class="result-value col-md-8">
	...
	{if $furtherSiteLinks}
		<div class="row archive-field-row">
			<div class="result-label col-md-4">Further Site Info: </div>
			<div class="result-value col-md-8">
	...
	{if $genealogyLinks}
		<div class="row archive-field-row">
			<div class="result-label col-md-4">Genealogy Link: </div>
			<div class="result-value col-md-8">
