...
<div class="archive-compound-grid">
    {foreach from=$children item=child name=audioLoop}
        <div class="audio-item archive-compound-item"
            ...
            {if $child.thumbnailUrl}
                <div class="archive-audio-item-thumbnail">
                    <img src="{$child.thumbnailUrl}"
                         alt="{$child.title|escape}"
                         class="archive-audio-item-thumbnail-image">
                </div>
            {else}
                <div class="archive-audio-item-thumbnail-placeholder">
