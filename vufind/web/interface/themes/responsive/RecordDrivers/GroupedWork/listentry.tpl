{strip}
	...
	{*<div class="col-lg-11">*}
			...
			{*<div class="row">*}
				...
				{/if}
		<div class="{if !$showCovers}col-12{else}col-sm-9 col-md-9{/if}">

			{if $summAuthor}
				<div class="row">
					<div class="result-label col-3 col-sm-3">Author: </div>
					<div class="result-value col-9 col-sm-9 notranslate">
			...
			<div class="row d-none d-sm-flex d-md-none">
				...
				{if !$hasHiddenFormats && count($relatedManifestations) != 1}
					<div class="hidethisdiv{$summId|escape} result-label col-3 col-sm-3">
						Formats:
					</div>
