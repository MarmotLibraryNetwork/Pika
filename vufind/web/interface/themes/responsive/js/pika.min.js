...
Pika.Archive2=function(){return{loadExploreMore:function(nid){$.getJSON("/Archive2/AJAX?method=getExploreMoreContent&id="+encodeURIComponent(nid),function(data){if(data.success){$("#explore-more-body").html(data.exploreMore);Pika.initCarousels("#explore-more-body .panel-collapse.in .jcarousel")}}).fail(Pika.ajaxFail)}}}();
