					...
					{if $showSearchTools}
						...
						&nbsp;&nbsp;<a href="#" onclick="return Pika.Account.ajaxLightbox('/Search/AJAX?method=getEmailForm');"><span class="glyphicon glyphicon-envelope" aria-hidden="true"></span>&nbsp;{translate text='Email this Search'}</a>
							{if $loggedIn && $savedSearch}
								...
								&nbsp;&nbsp;<a href="#" onclick="return Pika.Account.deleteSearch('{$searchId}',1,1)"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span>&nbsp;{translate text='save_search_remove'}</a>
							{else}
