...
<aside class="exploreMoreBar row" aria-labelledby="exploreMoreBarLabel">
	...
	<div class="exploreMoreContainer">
		<div class="jcarousel-wrapper" id="exploreMoreBarScroll">
			{* Scrolling Buttons *}
			<button class="jcarousel-control-prev"{* data-bs-target="-=1"*} aria-label="Previous Category"><i class="glyphicon glyphicon-chevron-left"></i></button>
			...
			<button class="jcarousel-control-next"{* data-bs-target="+=1"*} aria-label="Next Category"><i class="glyphicon glyphicon-chevron-right"></i></button>
		</div>
	</div>
