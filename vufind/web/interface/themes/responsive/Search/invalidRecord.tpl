	...
	<div id="main-content">
		...
		{if $enableMaterialsRequest}
			<p class="alert alert-info">
				Can't find what you are looking for? Try our <a href="/MaterialsRequest/NewRequest" onclick="return VuFind.Account.followLinkIfLoggedIn(this);">{'Materials Request'|translate} Service</a>.
			</p>
