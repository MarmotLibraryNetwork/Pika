{if $cluster.showMoreFacetPopup}
	...
	{/foreach}
	{* Show more list *}
	<div class="facetValue" id="more{$title}"><a href="#" onclick="VuFind.ResultsList.moreFacetPopup('More options for {$cluster.label}', '{$title}'); return false;">{translate text='more'} ...</a></div>
