{strip}
	...
	<div class="row" id="selected-browse-label">{* browse styling replicated here *}
		<div class="btn-group btn-group-sm">
			...
			<button tabindex="0" title="Lists" class="btn btn-sm btn-outline-secondary displayMode" aria-label="change results to list layout" onclick="Pika.Searches.toggleDisplayMode(this.id)" id="list">
