{strip}
			<div class="searchtools well small">
				<strong>{translate text='Series Tools'}:</strong>
						...
						&nbsp;&nbsp;<a href="#" onclick="return Pika.GroupedWork.exportSeriesToExcel('{$recordDriver->getPermanentId()|escape:"url"}' )"><span class="glyphicon glyphicon-th" aria-hidden="true"></span>&nbsp;{translate text='Export To Excel'}</a>
			</div>
{/strip}