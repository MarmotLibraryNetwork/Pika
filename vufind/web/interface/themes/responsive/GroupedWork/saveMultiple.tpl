<form class="form-horizontal" id="save-to-list-form">
	<div>
	  ...
	  {if $showLists}
		  <div class="row mb-3">
			  ...
			  <div class="col-md-9">
				  ...
				  &nbsp;or&nbsp;
				  <button class="btn btn-sm btn-outline-secondary" onclick="return Pika.Account.showCreateListMultipleForm('{$textIds}')">{translate text="Create a New List"}</button>
			  </div>
			</div>
		{else}
		  <button class="btn btn-sm btn-outline-secondary" onclick="return Pika.Account.showCreateListMultipleForm('{$textIds}')">{translate text="Create a New List"}</button>
	  ...
	  {if $showLists}
			<div class="row mb-3">
				<div class="col-md-3"><strong>Titles To Add:</strong></div>
				<div class="col-md-9">
						<ul>
