{strip}
	...
	<form name="listForm" class="form form-horizontal" id="addListForm">
		<div class="row mb-3">
			<label for="listTitle" class="col-md-3 col-form-label">{translate text="List"}:</label>
			<div class="col-md-9">
				<input type="text" id="listTitle" name="title" value="{$listTitle|escape:"html"}" size="50" class="form-control">
			</div>
		</div>
		<div class="row mb-3">
		  <label for="listDesc" class="col-md-3 col-form-label">{translate text="Description"}:</label>
			<div class="col-md-9">
		    <textarea name="desc" id="listDesc" rows="3" cols="50" class="form-control">{$list->desc|escape:"html"}</textarea>
			</div>
		</div>
		<div class="row mb-3">
			<label for="public" class="col-md-3 col-form-label">{translate text="Allow Public Access"}:</label>
			<div class="col-md-9">
