...
{*			</div>*}
			...
			<div class="rating-graph">
				<div class="row">
					...
					<div class="col-sm-5"><div class="graph-bar" style="width:{$ratingData.barWidth5Star}%">&nbsp;</div></div>
					<div class="col-sm-2">({$ratingData.num5star})</div>
				</div>
				<div class="row">
					<div class="col-sm-4">4 star</div>
					<div class="col-sm-5"><div class="graph-bar" style="width:{$ratingData.barWidth4Star}%">&nbsp;</div></div>
					<div class="col-sm-2">({$ratingData.num4star})</div>
				</div>
				<div class="row">
					<div class="col-sm-4">3 star</div>
					<div class="col-sm-5"><div class="graph-bar" style="width:{$ratingData.barWidth3Star}%">&nbsp;</div></div>
					<div class="col-sm-2">({$ratingData.num3star})</div>
				</div>
				<div class="row">
					<div class="col-sm-4">2 star</div>
					<div class="col-sm-5"><div class="graph-bar" style="width:{$ratingData.barWidth2Star}%">&nbsp;</div></div>
					<div class="col-sm-2">({$ratingData.num2star})</div>
				</div>
				<div class="row">
					<div class="col-sm-4">1 star</div>
					<div class="col-sm-5"><div class="graph-bar" style="width:{$ratingData.barWidth1Star}%">&nbsp;</div></div>
					<div class="col-sm-2">({$ratingData.num1star})</div>
				</div>
			</div>
			{/if}
