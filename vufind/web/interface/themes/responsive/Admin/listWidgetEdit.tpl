...
{strip}
	<div id="main-content">
		...
		<div class="btn-group">
			<a class="btn btn-sm btn-outline-secondary" href="/Admin/ListWidgets">All Widgets</a>
			<a class="btn btn-sm btn-outline-secondary" href="/Admin/ListWidgets?objectAction=view&id={$object->id}">View</a>
			<a class="btn btn-sm btn-outline-secondary" href="/API/SearchAPI?method=getListWidget&id={$object->id}">Preview</a>
			{if $canDelete}
