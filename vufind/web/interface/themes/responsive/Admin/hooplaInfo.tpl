	...
	<div id="page-content" class="col-12">
		...
		<div id="main-content">
			{if !empty($hooplaRecordData)}
				<div class="row">
					<div class="col-3"><strong>Using Hoopla Library Id :</strong></div>
					<div class="col-3">{$hooplaLibraryId}</div>
					<div class="col-6"><div class="alert {if $success}alert-success{else}alert-warning{/if}">{$message}</div></div>
				</div>
{*				<div class="row">
					<div class="col-12">
