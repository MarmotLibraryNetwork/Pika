{strip}
	{foreach from=$militaryRecords item=militaryRecord}
		<div class="row">
			<div class="result-label col-md-12"><a href="{$militaryRecord.branchLink}">{$militaryRecord.branch}</a>
		...
		{if $militaryRecord.conflict}
			<div class="row">
				<div class="result-label col-md-4">Served in: </div>
		...
		{if $militaryRecord.highestRank}
			<div class="row">
				<div class="result-label col-md-4">Highest rank attained: </div>
				<div class="result-value col-md-8">
		...
		{if count($militaryRecord.locationsServed)}
			{foreach from=$militaryRecord.locationsServed item=locationServed}
				...
				<div class="row">
					<div class="result-label col-md-4">Served at: </div>
					<div class="result-value col-md-8">
