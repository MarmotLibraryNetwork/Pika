			...
			<div class="archiveComponentBody">
				<div class="archiveComponentBox">
					...
					<div class="archiveComponentRandomImage row">
						...
						<button id="refreshRandomImage" class="btn btn-outline-secondary" onclick="return Pika.Archive.nextRandomObject('evld:localHistoryArchive');"><img src="/interface/themes/responsive/images/refresh.png" alt="New Random Image"></button>
					</div>
				</div>
			</div>
		</div>
