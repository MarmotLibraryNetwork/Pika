{strip}
	<div class="alert alert-warning">
		...
		{else}
			...
			<a href="/MyAccount/Home" class="btn btn-outline-secondary loginLink" data-login="true" title="{translate text='Login'}" onclick="{if $isLoginPage}$('#username').focus();return false{else}return Pika.Account.followLinkIfLoggedIn(this);{/if}">{translate text='Log In'}</a>
		{/if}
	</div>
{/strip}