	...
	<form id="accessibilityReport" action="/Help/accessibilityReportForm" method="post">
      ...
      {if !$loggedIn}
				<div class="form-group">
					<label for='libraryCardNumber' class="control-label">Library Card Number: </label><input type="text" name="libraryCardNumber" id="libraryCardNumber"  maxlength="20" size="20">
				</div>
      {/if}
		<div class="form-group">
