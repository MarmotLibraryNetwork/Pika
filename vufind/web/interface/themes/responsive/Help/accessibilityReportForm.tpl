<div class="col-tn-12">
	...
	<form id="accessibilityReport" action="/Help/accessibilityReportForm" method="post">
		...
		<div class="form-group">
			<label for="name" class="control-label">Name: <span class="requiredIndicator">*</span></label><input type="text" name="name" aria-required="true" id="name" class="required form-control" maxlength="120" size="60" value="{$name}">
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			<label for="email" class="control-label">E-mail: <span class="requiredIndicator">*</span></label><input type="text" name="email" id="email" aria-required="true" class="required email form-control" maxlength="120" size="60" value="{$email}">
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			<label for="report" class="control-label">Please describe your issue: <span class="requiredIndicator" aria-required="true">*</span></label><br>
