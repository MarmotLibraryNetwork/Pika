...
{*
		...
		<script src="/interface/themes/responsive/js/lib/bootstrap.bundle.min.js?v={$assetVersion}"></script>
	...
	{* autocomplete still uses jquery=-ui*}
		...
		{if !$isListWidget}
			<script src="/interface/themes/responsive/js/lib/datatables.js?v={$assetVersion}"></script>
		{/if}
	{else}
		...
		{if !$isListWidget}
			<script src="/interface/themes/responsive/js/lib/datatables.min.js?v={$assetVersion}"></script>
		{/if}
		{if ($action == 'Covers')}
