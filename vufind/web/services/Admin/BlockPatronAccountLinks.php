...
class Admin_BlockPatronAccountLinks extends ObjectEditor {
	...
	function getInstructions(){
		...
		<br>
 		...
 		<span class="bi bi-exclamation-triangle-fill" aria-hidden="true"></span> Blocking a patron from linking accounts will not prevent a user from manually logging into other accounts.
