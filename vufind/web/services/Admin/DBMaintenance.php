...
//			$dbUpdate->date_run = time(); // table should auto-set this column
    ...
    private function splitLargeLists()
    {
            ...
            foreach ($allLists as $aList) {
                $numItems = 0;
                if ($aList->numValidListItems()) {
                    $numItems = $aList->numValidListItems();
                }
                if ($numItems > 2000) {
                    $largeLists[$i] = array('id' => $aList->id, 'num' => $numItems);
                    $i++;
                }
            ...
            foreach ($largeLists as $largeList) {
                ...
                while ($y <= $x) {
                    ...
                    $newList->description = $bigList->description . " (autogenerated by list splitter part " . $n . ")";
