...
use Administration\ListMigration;

require_once ROOT_DIR . '/services/Admin/Admin.php';
class Admin_ListMigration extends Admin_Admin
{
	...
	function getMigrationCount(){
		$migrations = new ListMigration();
		return $migrations->count();
	}

	function getInstructions(){
		return 'For more information on List Migration please see our documentation.';
	}
