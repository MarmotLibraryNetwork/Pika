		...
		if (UserAccount::userHasRole('opacAdmin')){
			...
			if ($copyFrom->get($fromLocationId)){
				...
				if ($library->insert()){
					...
					$results['buttons'] = '<button class="btn btn-default" title="SaveReturn" onclick="location.href=\'/Admin/Libraries;\'">Return to Library List</button><button class="btn btn-primary" type="button" title="SaveEdit" onclick="location.href=\'' . $editLink . '\';">Edit New Library</button>';
				}
