...
class Marmot extends Sierra{
	...
	public function getSelfRegistrationFields(){
		...
		$fields[] = array('property'=>'physicalAddress', 'type'=>'text', 'label'=>'Physical Address (if different than Mailing Address)', 'description'=>'Physical Address (if different than Mailing Address)', 'maxLength' => 128, 'required' => false);
