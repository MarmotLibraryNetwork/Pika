...
//		global $library;
//		$fields   = [];
//		$fields[] = ['property' => 'firstName', 'type' => 'text', 'label' => 'First Name', 'description' => 'Your first name', 'maxLength' => 25, 'required' => true];
//		$fields[] = ['property' => 'middleName', 'type' => 'text', 'label' => 'Middle Name', 'description' => 'Your middle name', 'maxLength' => 25, 'required' => false];
//		// gets added to the first name separated by a space
//		$fields[] = ['property' => 'lastName', 'type' => 'text', 'label' => 'Last Name', 'description' => 'Your last name', 'maxLength' => 60, 'required' => true];
//		$fields[] = ['property' => 'suffix', 'type' => 'text', 'label' => 'Suffix', 'description' => 'Your suffix', 'maxLength' => 15, 'required' => false];
//		if ($library && $library->promptForBirthDateInSelfReg){
//			$fields[] = ['property' => 'birthDate', 'type' => 'date', 'label' => 'Date of Birth (MM-DD-YYYY)', 'description' => 'Date of birth', 'maxLength' => 10, 'required' => true];
//		}
//		$fields[] = ['property' => 'address', 'type' => 'text', 'label' => 'Address', 'description' => 'Address', 'maxLength' => 128, 'required' => true];
...
//		$fields[] = ['property' => 'city', 'type' => 'text', 'label' => 'City', 'description' => 'City', 'maxLength' => 48, 'required' => true];
//		$fields[] = ['property' => 'state', 'type' => 'text', 'label' => 'State', 'description' => 'State', 'maxLength' => 2, 'default' => 'MD', 'required' => true];
//		$fields[] = ['property' => 'zip', 'type' => 'text', 'label' => 'Zip Code', 'description' => 'Zip Code', 'maxLength' => 32, 'required' => true];
//		$fields[] = ['property' => 'email', 'type' => 'email', 'label' => 'E-Mail', 'description' => 'E-Mail', 'maxLength' => 128, 'required' => false];
//		$fields[] = ['property' => 'phone', 'type' => 'text', 'label' => 'Phone (xxx-xxx-xxxx)', 'description' => 'Phone', 'maxLength' => 128, 'required' => false];
//		$fields[] = ['property' => 'pin', 'type' => 'pin', 'label' => 'Pin (Save this number)', 'description' => 'Pin (Save this number)', 'maxLength' => 25, 'required' => true];
//		$fields[] = ['property' => 'pin1', 'type' => 'pin', 'label' => 'Re-enter Pin (Save this number)', 'description' => 'Pin (Save this number)', 'maxLength' => 25, 'required' => true];
//
...
//			$fields[] = ['property' => 'pickupLocation', 'type' => 'enum', 'label' => 'Preferred Library', 'description' => 'Please choose the Library location you would prefer to use', 'values' => $pickupLocations, 'required' => true];
//		}
//
//
//		return $fields;
