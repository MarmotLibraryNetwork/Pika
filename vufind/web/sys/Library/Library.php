...
//	public $archiveRequestFieldEmail;
	...
	public function getObjectStructure(){
        ...
        $lib = new Library();
        $lib_partners = $lib->getLibrariesForPartner();
		$structure = [
			...
			'partnerOfSystem'          => ['property'=> 'partnerOfSystem', 'type'=> 'enum', 'values'=> $lib_partners, 'description' => 'Which library is this library partner to?', 'label'=>'Partner Of', 'hideInLists' => true],
			...
			'archiveSection' => ['property' =>'archiveSection', 'type' => 'section', 'label' =>'Local Content Archive', 'hideInLists' => true, 'helpLink' =>'https://marmot-support.atlassian.net/l/c/RdAMY41Q', 'properties' => [
				...
				'libraryTid'                           => ['property' => 'libraryTid', 'type' => 'enum', 'values'=> self::getLibraryTidChoices(),'label' => 'Library Taxonomy Term ID', 'description' => 'The Islandora2 taxonomy term ID (TID) for this library entity', 'hideInLists' => true],
