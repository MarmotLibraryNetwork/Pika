...
//	public $archiveRequestFieldEmail;
	...
	static function getObjectStructure(){
		...
		$structure = [
			...
			'archiveOnlyInterface'     => ['property' => 'archiveOnlyInterface', 'type'=> 'checkboxWarn', 'label' => 'Archive Only Interface', 'description' => 'Whether or not the interface should only include archive objects', 'hideInLists' => true, 'default' => false],
