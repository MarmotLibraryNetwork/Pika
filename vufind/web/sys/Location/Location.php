...
// Don't explicitly declare this property.  Calls to it trigger its look up when it isn't set
	...
	function getObjectStructure(){
		...
		$structure = [
			...
			'scopeType'                       => ['property' => 'scopeType', 'type' => 'enum', 'label' => 'Location Search Scope Type', 'description' => 'The type of search scope to use for this location', 'required' => true, 'isIndexingSetting' => true, 'changeRequiresReindexing' => true, 'values' => self::LOCATION_SEARCH_SCOPE_TYPES, 'hideInLists' => true],
