...
class ArchiveRequest extends DB_DataObject
{
    ...
    public static function getObjectStructure()
    {
        $structure = [
	        ...
	        ['property' => 'address', 'type' => 'text', 'label' => 'Address', 'description' => 'Address', 'maxLength' => 200, 'required' => false, 'hideInLists' => true],
	        ['property' => 'address2', 'type' => 'text', 'label' => 'Address 2', 'description' => 'Address 2', 'maxLength' => 200, 'required' => false, 'hideInLists' => true],
	        ['property' => 'city', 'type' => 'text', 'label' => 'City', 'description' => 'City', 'maxLength' => 200, 'required' => false, 'hideInLists' => true],
	        ['property' => 'state', 'type' => 'text', 'label' => 'State', 'description' => 'State', 'maxLength' => 200, 'required' => false, 'hideInLists' => true],
	        ['property' => 'zip', 'type' => 'text', 'label' => 'Zip/Postal Code', 'description' => 'Address', 'maxLength' => 12, 'required' => false, 'hideInLists' => true],
	        ['property' => 'country', 'type' => 'text', 'label' => 'Country', 'description' => 'Country', 'maxLength' => 50, 'required' => false, 'default' => 'United States', 'hideInLists' => true],
	        ['property' => 'phone', 'type' => 'text', 'label' => 'Phone', 'description' => 'Phone', 'maxLength' => 20, 'required' => true],
	        ['property' => 'alternatePhone', 'type' => 'text', 'label' => 'Alternate Phone', 'description' => 'Alternate Phone', 'maxLength' => 20, 'required' => false, 'hideInLists' => true],
