 ...
 *
 * A Pika session class implementing the PHP SessionHandlerInterface
 *
 * @category Pika
 * @package  Session
 * @author   Chris Froese
 * @link     https://www.phparch.com/2018/01/php-sessions-in-depth/
 * @link     https://www.php.net/SessionHandlerInterface
 */
class MemcachedSession extends SessionHandler implements SessionHandlerInterface {
