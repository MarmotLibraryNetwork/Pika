...
class TimeToReshelve extends DB_DataObject {
	...
	static function getObjectStructure(){
		...
		$structure = array(
			...
			'groupedStatus'      => array('property' => 'groupedStatus', 'type' => 'enum', 'label' => 'Grouped Status', 'description' => 'The Status to display to the when grouping multiple copies', 'hideInLists' => false, 'default' => false,
				'values'   => array(
