...
class IndexingProfile extends DB_DataObject{
	...
	function getObjectStructure(){
		...
		$structure = array(
			...
			'materialTypeField'          => array('property' => 'materialTypeField',          'type' => 'text', 'label' => 'Material Type Sub Field', 'maxLength' => 3, 'description' => 'Material Type Field', 'hideInLists' => true, 'default' => 'd'),
