...
function getSierraAPIUpdates(){
	return [
		...
		'remove_sierra_export_fields_2021.01.0' => [
			'title'       => 'Remove obsolete Sierra Export Mapping Fields.',
			'description' => 'Remove obsolete Sierra Export Mapping Fields for bcode3.',
			'sql'         => [
				'ALTER TABLE `sierra_export_field_mapping` DROP COLUMN `bcode3DestinationSubfield`, DROP COLUMN `bcode3DestinationField`;',
			]
		],
