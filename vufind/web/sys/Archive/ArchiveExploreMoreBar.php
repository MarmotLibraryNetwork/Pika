...
class ArchiveExploreMoreBar extends DB_DataObject {
	...
	public static function getObjectStructure() {
		$structure = [
			...
			'section'       => ['property' => 'section', 'type' => 'enum', 'label' => 'Explore More Section', 'description' => 'The section of the Explore More Bar to be displayed', 'hideInLists' => true,
			                    'values'   => self::$archiveSections],
			'displayName'   => ['property' => 'displayName', 'type' => 'text', 'label' => 'Display Name (optional)', 'description' => 'Label for the section that will be displayed to users. If blank, the section\'s default name will be used.'],
			'openByDefault' => ['property' => 'openByDefault', 'type' => 'checkbox', 'label' => 'Is Section Open By Default', 'description' => 'Whether or not the section will be displayed as open to users initially.', 'hideInLists' => true, 'default' => true],
			//'weight'        => ['property' => 'weight', 'type' => 'integer', 'label' => 'Sort', 'description' => 'The sort order of rule', 'default' => 0],
