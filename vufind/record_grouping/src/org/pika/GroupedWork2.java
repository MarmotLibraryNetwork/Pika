 ...
 * Time: 9:02 AM
 */
public class GroupedWork2 extends GroupedWorkBase implements Cloneable {
	...
	private static Logger logger = LogManager.getLogger(GroupedWork2.class);
	...
	private String normalizeAuthor(String author) {
		...
		try {
			String authorityRecord = VIAF.getAuthorAuthorityWithWebservice(author);
			if (authorityRecord != null) {
				author = authorityRecord;
			}
		}catch(Exception e){
			logger.warn("Error loading authority for author", e);
		}
