...
checkConflictingProcesses "symphony_export.jar ${PIKASERVER}" >> ${OUTPUT_FILE}
...
: > $OUTPUT_FILE;
#/usr/local/vufind-plus/vufind/cron/moveFullExport.sh aacpl/symphony aacpl.production >> ${OUTPUT_FILE}
